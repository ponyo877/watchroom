...
export default function ChatPanel({
  ...
  return (
    <div className="h-full flex flex-col bg-card/50 backdrop-blur-sm rounded-b-xl overflow-hidden">

      <div className="flex-1 overflow-y-auto p-4 space-y-3 relative chat-container">
        {/* Top fade gradient */}
      ...
      {/* Footer - モバイルはMobileChatInput、デスクトップは通常の入力 */}
      {isMobile ? (
        <MobileChatInput
